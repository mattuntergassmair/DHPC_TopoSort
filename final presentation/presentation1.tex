...
\begin{columns}[T]
 \column{0.5\textwidth}
  ...
  \begin{figure}[!ht]
    \begin{center}
      %\includegraphics[width=\textwidth]{img/strongscaling_bitset_gtRANDOMLIN_opt1.pdf}
    \end{center}
  \end{figure}
 ...
 \column{0.5\textwidth}
  ...
  \begin{figure}[!ht]
    \begin{center}
      %\includegraphics[width=\textwidth]{img/strongscaling_locallist_gtRANDOMLIN_opt0.pdf}
    \end{center}
  \end{figure}
\end{columns}
