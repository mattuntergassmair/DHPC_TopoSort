...
So far we have seen that the Node-Lookup and Worksteal implementations do in fact allow us to speed up the topological sorting by using multiple threads.
